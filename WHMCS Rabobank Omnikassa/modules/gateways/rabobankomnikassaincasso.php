...
function rabobankomnikassaincasso_config() {
    $configarray = array(
        "FriendlyName" => array("Type" => "System", "Value" => "Rabobank Omnikassa Automatische Incasso"),
...
function rabobankomnikassaincasso_link($params) {
# Gateway Specific Variables
    ...
    $customer_return_url = $systemurl . '/modules/gateways/callback/rabobankomnikassaincasso.php';
    ...
    $data .= '|paymentMeanBrandList=INCASSO';
