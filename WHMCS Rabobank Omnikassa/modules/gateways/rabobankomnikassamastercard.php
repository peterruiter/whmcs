...
function rabobankomnikassamastercard_config() {
    $configarray = array(
        "FriendlyName" => array("Type" => "System", "Value" => "Rabobank Omnikassa Mastercard"),
...
function rabobankomnikassamastercard_link($params) {
# Gateway Specific Variables
    ...
    $customer_return_url = $systemurl . '/modules/gateways/callback/rabobankomnikassamastercard.php';
    ...
    $data .= '|paymentMeanBrandList=MASTERCARD';
