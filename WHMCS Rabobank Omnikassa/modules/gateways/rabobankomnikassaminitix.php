...
function rabobankomnikassaminitix_config() {
    $configarray = array(
        "FriendlyName" => array("Type" => "System", "Value" => "Rabobank Omnikassa Minitix"),
...
function rabobankomnikassaminitix_link($params) {
# Gateway Specific Variables
    ...
    $customer_return_url = $systemurl . '/modules/gateways/callback/rabobankomnikassaminitix.php';
    ...
    $data .= '|paymentMeanBrandList=MINITIX';
