...
function rabobankomnikassamaestro_config() {
    $configarray = array(
        "FriendlyName" => array("Type" => "System", "Value" => "Rabobank Omnikassa Maestro"),
...
function rabobankomnikassamaestro_link($params) {
# Gateway Specific Variables
    ...
    $customer_return_url = $systemurl . '/modules/gateways/callback/rabobankomnikassamaestro.php';
    ...
    $data .= '|paymentMeanBrandList=MAESTRO';
