...
function rabobankomnikassarembours_config() {
    $configarray = array(
        "FriendlyName" => array("Type" => "System", "Value" => "Rabobank Omnikassa Rembours"),
...
function rabobankomnikassarembours_link($params) {
# Gateway Specific Variables
    ...
    $customer_return_url = $systemurl . '/modules/gateways/callback/rabobankomnikassarembours.php';
    ...
    $data .= '|paymentMeanBrandList=REMBOURS';
