...
$gatewaymodule = "rabobankomnikassaincasso"; # Enter your gateway module name here
...
$customer_return_url = $GATEWAY['systemurl'] . '/modules/gateways/callback/rabobankomnikassaincasso.php';
