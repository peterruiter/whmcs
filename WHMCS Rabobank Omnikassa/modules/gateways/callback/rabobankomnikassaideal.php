...
$gatewaymodule = "rabobankomnikassaideal"; # Enter your gateway module name here
...
$customer_return_url = $GATEWAY['systemurl'] . '/modules/gateways/callback/rabobankomnikassaideal.php';
