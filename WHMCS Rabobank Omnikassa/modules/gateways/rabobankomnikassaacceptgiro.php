...
function rabobankomnikassaacceptgiro_config() {
    $configarray = array(
        "FriendlyName" => array("Type" => "System", "Value" => "Rabobank Omnikassa Acceptgiro"),
...
function rabobankomnikassaacceptgiro_link($params) {
# Gateway Specific Variables
    ...
    $customer_return_url = $systemurl . '/modules/gateways/callback/rabobankomnikassaacceptgiro.php';
    ...
    $data .= '|paymentMeanBrandList=ACCEPTGIRO';
