...
function rabobankomnikassavpay_config() {
    $configarray = array(
        "FriendlyName" => array("Type" => "System", "Value" => "Rabobank Omnikassa vpay"),
...
function rabobankomnikassavpay_link($params) {
# Gateway Specific Variables
    ...
    $customer_return_url = $systemurl . '/modules/gateways/callback/rabobankomnikassavpay.php';
    ...
    $data .= '|paymentMeanBrandList=VPAY';
