...
function rabobankomnikassaideal_config() {
    $configarray = array(
        "FriendlyName" => array("Type" => "System", "Value" => "Rabobank Omnikassa iDEAL"),
...
function rabobankomnikassaideal_link($params) {
# Gateway Specific Variables
    ...
    $customer_return_url = $systemurl . '/modules/gateways/callback/rabobankomnikassaideal.php';
    ...
    $data .= '|paymentMeanBrandList=IDEAL';
