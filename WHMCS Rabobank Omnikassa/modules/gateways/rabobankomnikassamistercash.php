...
function rabobankomnikassamistercash_config() {
    $configarray = array(
        "FriendlyName" => array("Type" => "System", "Value" => "Rabobank Omnikassa Mister Cash"),
        "partnerId" => array("FriendlyName" => "Winkel ID", "Type" => "text", "Size" => "15",),
        "defaultLanguage" => array("FriendlyName" => "Standaard taal", "Type" => "dropdown", "Options" => "Nederlands,Engels,Frans,Duits,Spaans,Italiaans","Description" => "<br>De betaalpagina wordt standaard in de gekozen (profiel)taal van de gebruiker getoond. De optie hier wordt gebruikt indien de gebruiker een taal heeft geselecteerd welke niet door de Rabobank wordt ondersteund."),
...
function rabobankomnikassamistercash_link($params) {
# Gateway Specific Variables
    ...
    switch ($params['clientdetails']['language']) {
        case 'english':
            $gatewayLanguage = 'en';
            break;        
        case 'italian':
        ...
        case 'spanish':
            ...
            break;
        default: 
            $gatewayLanguage = $defaultLanguage;
            break;
    }     
	switch ($gatewayLanguage) {
        case 'en':
			$paymentButton = 'Pay now';
            break;        
        case 'it':
			$paymentButton = 'Pagare';
            break;        
        case 'fr':
			$paymentButton = 'Payer';
            break;        
        case 'de':
			$paymentButton = 'Zahlen';
            break;        
        case 'nl':
			$paymentButton = 'Betalen';
            break;
        case 'es':
			$paymentButton = 'Pagar';
            break;        
    ...
    $customer_return_url = $systemurl . '/modules/gateways/callback/rabobankomnikassamistercash.php';
    ...
    $data .= 'customerLanguage=' . $gatewayLanguage . '|';

    // Optionele velden
    $data .= 'orderId=' . $invoiceid;        
    $data .= '|paymentMeanBrandList=BCMC';
